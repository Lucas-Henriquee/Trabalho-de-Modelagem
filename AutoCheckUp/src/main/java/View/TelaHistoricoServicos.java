...
public class TelaHistoricoServicos implements MouseListener {
     ...
     public TelaHistoricoServicos(Cliente cliente, Veiculo veiculo) {
     ...
     private void painel2() {
          ...
          JLabel jlHistorico = new JLabel("Histórico de Serviços");
